...
class Ena(VisaInstrument):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.add_function(
            name="preset",
            call_cmd="SYST:PRES;:OUTP OFF;:TRIG:SOUR BUS",
        )
        self.preset()
        ...
        self.trigger_source = Parameter(
            ...
            get_cmd="TRIG:SOUR?",
            set_cmd="TRIG:SOUR {}",
            val_mapping={"internal": "INT", "external": "EXT", "manual": "MAN", "bus": "BUS"},
        )
        self.point_trigger = Parameter(
            name="point_trigger",
            instrument=self,
            get_cmd="TRIG:POIN?",
            set_cmd="TRIG:POIN {}",
        ...
        # trigger input
        self.trigger_input_delay = Parameter(
            name="trigger_input_delay",
            instrument=self,
            get_cmd="TRIG:EXT:DEL?",
            set_cmd="TRIG:EXT:DEL {:.5f}",
            unit="s",
            vals=Numbers(0, 1),
        )
        self.trigger_input_polarity = Parameter(
        ...
        self.trigger_output_position = Parameter(
            name="trigger_output_position",
            instrument=self,
            get_cmd="TRIG:OUTP:POS?",
            set_cmd="TRIG:OUTP:POS {}",
            val_mapping={"after": "AFT", "before": "BEF"},
        )
        self.trigger_output_polarity = Parameter(
            name="trigger_output_polarity",
            instrument=self,
            get_cmd="TRIG:OUTP:POL?",
        ...
        self.format = Parameter(
            name="format",
            instrument=self,
            get_cmd="CALC:TRAC:FORM?",
            set_cmd="CALC:TRAC:FORM {}",
            val_mapping={
